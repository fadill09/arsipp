...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-2">
            <a href="arsip-tambah" style="text-decoration: none"><button class="btn btn-primary btn-primary"
                    style="height: 50px">Arsipkan Surat</button></a>
        </div>
                            ...
                            @else
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td><a href="" id="kategori_surat"></a>{{ $item->kategori }}</td>
                                        <td><a href=""
                                                id="judul_surat"></a>{{$item->judul}}</td>
                                        <td><a href=""
                                                id="waktu"></a>{{ \Carbon\Carbon::parse($item->Waktu)->format('d-m-Y H:i:s') }}
                                        </td>
                                        <td>
