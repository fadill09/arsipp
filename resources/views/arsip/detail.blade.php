    ...
    <div class="row">
        <div class="col-lg-12 mb-4">
            <p>Nomor : {{ $arsip->nomor_surat }}
                <br>Kategori : {{ $arsip->kategori }}
                <br>Judul : {{ $arsip->judul }}
                <br>Waktu unggah : {{ \Carbon\Carbon::parse($arsip->Waktu)->format('d-m-Y H:i:s') }}
            </p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="row g-0">
                    <div class="col-md-9">
                        <iframe class="m-2" src="{{ asset('/storage/files/' . $arsip->file) }}" align="top"
                            height="700px" width="100%" frameborder="0" scrolling="auto"></iframe>
                    </div>
                    <div class="col-md-3">
                        <a href="/" class="btn btn-warning btn-block mt-2"><i class="fas fa-arrow-circle-left"></i>
                            Kembali</a>
